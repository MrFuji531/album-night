...
export default function Tv() {
  ...
  useEffect(() => {
    const onResize = () => {
      ...
      const safe = 0.92 // TV safe area - slightly smaller for Firestick
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div>
            <div className="h2" style={{ color: 'var(--gold)', marginBottom: 0, fontSize: '1.5rem' }}>
              {session.title}
            </div>
            <div className="font-mono" style={{ opacity: 0.6, fontSize: '0.875rem' }}>{code}</div>
          </div>
        ...
        >
          <AnimatePresence mode="wait">
            ...
            {session.status === 'lobby' && (
              ...
              >
                <div className="card card-glow text-center" style={{ padding: 32 }}>
                ...
                <div className="card" style={{ padding: 32 }}>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
                    {participants.map((p) => (
                      <div
                        ...
                        style={{ opacity: p.claimed ? 1 : 0.5, padding: 20 }}
                      >
                  ...
                  {allJoined && (
                    <div style={{ marginTop: 20 }} className="pill pill-success">
                    ...
                    return (
                      ...
                      >
                        <Avatar
                          ...
                          glow={hasSubmitted}
                        />
                        <div style={{ marginTop: 12, fontWeight: 700, fontSize: '1.25rem' }}>{p.name}</div>
                ...
                {!awardRevealComplete ? (
                  ...
                  >
                    ...
                    <div className="text-center" style={{ flex: '0 0 auto' }}>
                      <div className="h1" style={{ color: 'var(--gold)', margin: 0, fontSize: '3rem' }}>
                        FINAL RESULTS
                      </div>
                    ...
                    <div style={{ flex: '0 0 auto' }}>
                      <div className="grid-4" style={{ maxWidth: 1400, margin: '0 auto', gap: 20 }}>
                        {participants.map(p => (
                          <div key={p.participant_id} className="card text-center" style={{ padding: 20 }}>
                            <Avatar
                              participantId={p.participant_id}
                              name={p.name}
                              avatarUrl={p.avatar_url}
